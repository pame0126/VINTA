 ...
 * @author Wifuss
 */
@WebServlet(name = "AñadirPrenda", urlPatterns = {"/A_adirPrenda"})
public class AñadirPrenda extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String tituloP = request.getParameter("titulo");
             ...
             f.add(fotosP);
             Prenda sql=new Prenda(tituloP,categoriaP,costoP,descripcionP,f,emailP,telefonoP);
             //conexion oracle
